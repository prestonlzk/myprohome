...
const defaultMessage = "Hi MyHomePro! I need help with my home. Can you assist?"

export default function WhatsAppButton({ service }: { service?: string }) {
  const message = (service && messages[service]) || defaultMessage
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <a
        ...
        className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[#25D366] text-white font-poppins font-semibold text-[18px] py-[18px] px-9 rounded-xl hover:bg-[#1fba58] transition-colors"
      >
        <svg
      ...
      <p className="text-text-secondary text-[14px] font-inter">
        Tap above — we usually reply within 1 hour
      </p>
    </div>
  )
}
